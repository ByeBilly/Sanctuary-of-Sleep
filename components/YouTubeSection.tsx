        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative group aspect-video rounded-lg overflow-hidden border border-sanctuary-sage/40 shadow-2xl">
              ...
              <div className="absolute top-4 left-4 z-20 bg-sanctuary-dark/80 backdrop-blur border border-sanctuary-gold/40 px-3 py-1.5 rounded flex items-center gap-2 shadow-lg">
